...
public class MQConnector {
    ...
    public static void createRecord(String msg, String Queue) throws Exception {
        MSG = msg.toString();
        QUEUE = Queue.toString();
        thread(new Producer(), false);
    }
    public static void createRecordRaw(String msg, String Queue) throws Exception {
        MSG = msg.toString();
        QUEUE = Queue.toString();
        thread(new ProducerRaw(), false);
    }

    public static String readRecord(String Queue) throws Exception {
        QUEUE = Queue.toString();
    ...
    public static class Producer implements Runnable {
        public void run() {
            ...
            try {
                ...
                // Create a messages
                String text = "<xml><message data=" + MSG + "></message></xml> " + this.hashCode();
    ...
    public static class ProducerRaw implements Runnable {
        public void run() {
    ...
    public static class Consumer implements Runnable, ExceptionListener {
        public void run() {
            try {
                ...
                // Create the destination (Topic or Queue)
                Destination destination = session.createQueue("queue.tes.q");
                //Destination destination = session.createQueue(QUEUE);
